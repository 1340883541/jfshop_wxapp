...
Page({
    ...
    quedingModal3() {
        ...
        this.setData({
            ['temp_conf_arr[' + this.data.d_tindex3 + '].time']: this.data.hour3 + ':' + this.data.minute3 + ':' + this.data.second3
        })
        // console.log(this.data.temp_conf_arr[this.data.d_tindex3].time)
        this.setData({
            value3: [this.data.hour3 - 1, this.data.minute3, this.data.second3]
        })
        this.hideModal3();
    },
    // 下拉数据选择器
    ...
    chooseImgFunc(e) {
        ...
        this.setData({
            imgsNum: Number(e.currentTarget.dataset.imgsnum) - Number(this.data.temp_conf_arr[this.data.d_tindex4].t_imgs.length)
        })
        ...
        if (i < imgarr.length) {
            wx.uploadFile({
                ...
                success(res) {
                    ...
                    _this.setData({
                        ['temp_conf_arr[' + _this.data.d_tindex4 + '].t_imgs']: _this.data.temp_conf_arr[_this.data.d_tindex4].t_imgs.concat(upImgs),
                        ['temp_conf_arr[' + _this.data.d_tindex4 + '].t_Upimgs']: _this.data.temp_conf_arr[_this.data.d_tindex4].t_Upimgs.concat(JSON.parse(res.data).data)

                    })
                    // console.log(_this.data.temp_conf_arr[_this.data.d_tindex4].t_imgs)
                    // console.log(_this.data.temp_conf_arr[_this.data.d_tindex4].t_Upimgs)
    ...
    delUpImgFunc(e) {
        ...
        Ajax.ajaxFunc({
            ...
            success: function (res) {
                if (res.code == 1) {
                    //do somethig
                    _this.data.temp_conf_arr[_this.data.d_tindex4].t_Upimgs.splice(_this.data.imgidx4, 1);
                    _this.data.temp_conf_arr[_this.data.d_tindex4].t_imgs.splice(_this.data.imgidx4, 1)

                    _this.setData({
                        ['temp_conf_arr[' + _this.data.d_tindex4 + '].t_imgs']: _this.data.temp_conf_arr[_this.data.d_tindex4].t_imgs,
                      ['temp_conf_arr[' + _this.data.d_tindex4 + '].t_Upimgs']: _this.data.temp_conf_arr[_this.data.d_tindex4].t_Upimgs,
                    })
